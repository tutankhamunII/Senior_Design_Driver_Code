...
static const _ActuatorPositions_type_support_symbol_names_t _ActuatorPositions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hexabot_msgs, msg, ActuatorPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hexabot_msgs, msg, ActuatorPositions)),
  }
};
...
{
  return &::hexabot_msgs::msg::rosidl_typesupport_cpp::ActuatorPositions_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hexabot_msgs, msg, ActuatorPositions)() {
  return get_message_type_support_handle<hexabot_msgs::msg::ActuatorPositions>();
}
